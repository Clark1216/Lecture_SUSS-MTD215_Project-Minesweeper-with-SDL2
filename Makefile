...
$(BIN_PATH)\$(OBJ_NAME) :  $(BIN_PATH)\main.o $(BIN_PATH)\loadTexture.o $(BIN_PATH)\minesweeper.o $(BIN_PATH)\menu.o $(BIN_PATH)\board.o $(BIN_PATH)\cell.o $(BIN_PATH)\button.o $(BIN_PATH)\UI_element.o
...
$(BIN_PATH)\HUD.o : $(SRC_PATH)\HUD.cpp $(INC_PATH)\HUD.h
	$(CC) -c $< $(INCLUDE_PATHS) -o $@	
