...
$(BIN_PATH)\$(OBJ_NAME) :  $(BIN_PATH)\main.o $(BIN_PATH)\loadTexture.o $(BIN_PATH)\UI_element.o $(BIN_PATH)\button.o $(BIN_PATH)\cell.o
	$(CC) $^ $(LIBRARY_PATHS) $(LINKER_FLAGS) -o $@

$(BIN_PATH)\main.o : $(SRC_PATH)\main.cpp $(INC_PATH)\loadTexture.h $(INC_PATH)\UI_element.h $(INC_PATH)\button.h $(INC_PATH)\cell.h
