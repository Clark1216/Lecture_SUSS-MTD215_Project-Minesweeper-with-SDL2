...
$(BIN_PATH)\$(OBJ_NAME) :  $(BIN_PATH)\main.o $(BIN_PATH)\menu.o $(BIN_PATH)\board.o $(BIN_PATH)\loadTexture.o $(BIN_PATH)\UI_element.o $(BIN_PATH)\button.o $(BIN_PATH)\cell.o $(BIN_PATH)\board.o
	$(CC) $^ $(LIBRARY_PATHS) $(LINKER_FLAGS) -o $@

$(BIN_PATH)\main.o : $(SRC_PATH)\main.cpp $(INC_PATH)\board.h $(INC_PATH)\menu.h $(INC_PATH)\cell.h
	$(CC) -c $< $(INCLUDE_PATHS) -o $@

$(BIN_PATH)\menu.o : $(SRC_PATH)\menu.cpp $(INC_PATH)\menu.h $(INC_PATH)\menu.h $(INC_PATH)\loadTexture.h $(INC_PATH)\button.h
	$(CC) -c $< $(INCLUDE_PATHS) -o $@	
